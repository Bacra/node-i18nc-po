...
function filterTranslateWords(json, lan, existedTranslateFilter)
{
	...
	var translateData = words.usedTranslateWords && words.usedTranslateWords[lan] || {};
	var codeTranslateWords = words.codeTranslateWords || {};
	if (codeTranslateWords.toJSON) codeTranslateWords = codeTranslateWords.toJSON();
